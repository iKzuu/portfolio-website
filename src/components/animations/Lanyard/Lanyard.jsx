...
function Band({ maxSpeed = 50, minSpeed = 0, isMobile = false, offset = DEFAULT_OFFSET }) {
  const band = useRef(),
    fixed = useRef(),
    j1 = useRef(),
    j2 = useRef(),
  ...
  useFrame((state, delta) => {
    ...
    if (fixed.current) {
      ...
      band.current.material.uniforms.repeat.value.x = -length * 0.9;
